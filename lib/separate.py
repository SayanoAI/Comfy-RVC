...
from .uvr5_pack.demucs.apply import apply_model, demucs_segments
from .uvr5_pack.demucs.hdemucs import HDemucs
from .uvr5_pack.demucs.model_v2 import auto_load_demucs_model_v2
from .uvr5_pack.demucs.pretrained import get_model as _gm
from .uvr5_pack.demucs.utils import apply_model_v1
from .uvr5_pack.demucs.utils import apply_model_v2
from .uvr5_pack import spec_utils
from .uvr5_pack.vr_network import nets
from .uvr5_pack.vr_network import nets_new
#from lib_v5.vr_network.model_param_init import ModelParameters
from pathlib import Path
from .uvr5_pack.constants import *
from .uvr5_pack.error_handling import *
import audioread
import gzip
import librosa
import math
...
import traceback
from .uvr5_pack import mdxnet as MdxnetSet

if TYPE_CHECKING:
    from .uvr5_pack.UVR import ModelData
    ...
    def loading_mix(self):
        ...
        for d in range(bands_n, 0, -1):        
            ...
            if d == bands_n: # high-end band
                X_wave[d], _ = librosa.load(self.audio_file, sr=bp['sr'], mono=False, dtype=np.float32, res_type=wav_resolution)
